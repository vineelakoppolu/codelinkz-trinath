...
const MobileApp = () => {
  ...
  const mainServices = [
    ...
    },
    {
      ...
      description:
        "Cost-effective apps built using React Native and Flutter for both platforms.",
    },
    {
      icon: <Layout className="w-12 h-12" />,
      title: "Mobile App UI/UX Design",
      description:
        "Modern, clean, and user-centered mobile designs that improve engagement.",
    },
    {
      icon: <Rocket className="w-12 h-12" />,
      title: "App Store Optimization",
      description:
        "ASO optimization for better visibility, downloads, and app growth.",
    },
  ];
  ...
  const additionalServices = [
    {
      ...
      description: "Real-time alerts and user engagement solutions.",
    },
    {
      icon: <Code className="w-8 h-8" />,
      title: "App API Integration",
      description: "Secure backend & API integration for mobile apps.",
    },
    {
      icon: <Layers className="w-8 h-8" />,
      title: "Backend Development",
      description: "Reliable backend for scalable mobile applications.",
    },
    {
      icon: <Palette className="w-8 h-8" />,
      title: "UI UX Services",
      description: "Custom UI/UX for premium mobile experiences.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              High-performance mobile applications built for iOS & Android with
              stunning UI, smooth performance, and modern technology.
            </p>
          </div>
        </div>
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              More mobile services to accelerate your app success
            </p>
          </div>
