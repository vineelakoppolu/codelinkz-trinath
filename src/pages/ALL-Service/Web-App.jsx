  ...
  const mainServices = [
    {
      ...
      description:
        "Fast, reliable, and installable web apps for an app-like experience on any device.",
    },
    {
      icon: <AppWindow className="w-12 h-12" />,
      title: "Single Page Applications (SPA)",
      description:
        "Modern SPAs with smooth navigation and dynamic content using React, Vue, or Angular.",
    },
    {
      icon: <Code className="w-12 h-12" />,
      title: "E-commerce Platforms",
      description:
        "Scalable and secure e-commerce solutions with payment integration and inventory management.",
    },
    {
      icon: <Layout className="w-12 h-12" />,
      title: "Content Management Systems",
      description:
        "Custom CMS solutions for managing content efficiently with easy-to-use interfaces.",
    },
  ];
  ...
  const additionalServices = [
    {
      ...
      description:
        "Enhancing speed, responsiveness, and SEO for better user engagement.",
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: "Backend Integration",
      description:
        "Reliable backend & API integration for your web applications.",
    },
    {
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description: "Custom UI/UX for responsive and intuitive web experiences.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              More web services to accelerate your business success
            </p>
          </div>
      ...
      <motion.section
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-700">
            Let’s turn your idea into a powerful web experience.
          </p>
          <Link to="/contact">
