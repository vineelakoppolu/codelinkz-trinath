  ...
  const mainServices = [
    {
      ...
      description:
        "Analyze and process human language for chatbots, sentiment analysis, and more.",
    },
    {
      icon: <Monitor className="w-12 h-12" />,
      title: "Computer Vision Solutions",
      description:
        "Detect, recognize, and process images and videos for intelligent automation.",
    },
    {
    ...
    },
    {
      ...
      description: "Automate customer interactions with smart AI agents.",
    },
  ];
  ...
  const additionalServices = [
    {
      ...
      description:
        "Custom AI models trained on your data for accurate predictions.",
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: "ML Pipeline Development",
      description:
        "End-to-end machine learning pipelines for automated workflows.",
    },
    {
      icon: <Camera className="w-8 h-8" />,
      title: "Computer Vision Solutions",
      description: "Implementing AI-based image & video recognition systems.",
    },
    {
      icon: <MessageSquare className="w-8 h-8" />,
      title: "NLP Solutions",
      description:
        "Natural Language Processing solutions for text & voice data.",
    },
  ];
    ...
    <motion.div
      ...
      <motion.section
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Intelligent solutions powered by AI & Machine Learning to automate
            processes and optimize business outcomes.
          </p>
        </div>
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              More AI & ML services to accelerate your business intelligence
            </p>
          </div>
      ...
      <motion.section
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Leverage AI?</h2>
          <p className="text-xl mb-8 text-gray-700">
            Let’s build intelligent systems that drive better business outcomes.
          </p>
          <Link to="/contact">
...
export default AIMachineLearing;
