  ...
  const mainServices = [
    {
      ...
      description:
        "Build scalable, resilient, cloud-native SaaS applications with microservices and containerized infrastructure.",
    },
    {
      icon: <Shield className="w-12 h-12" />,
      title: "Security & Compliance",
      description:
        "Enterprise-grade authentication, encryption, GDPR compliance, and secure multi-tenant user access.",
    },
    {
      icon: <Layers className="w-12 h-12" />,
      title: "Multi-Tenancy",
      description:
        "Serve multiple clients securely with isolated environments and scalable tenancy models.",
    },
    {
      icon: <Zap className="w-12 h-12" />,
      title: "Automation & Workflows",
      description:
        "Automate billing, onboarding, user provisioning, and operational workflows for seamless SaaS functionality.",
    },
  ];
  ...
  const additionalServices = [
    {
      ...
      description:
        "Powerful REST & GraphQL APIs to support integrations, mobile apps, and third-party systems.",
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: "Data Analytics & Reporting",
      description:
        "Real-time dashboards, insights, reporting modules, and AI-powered analytics for SaaS platforms.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Performance Optimization",
      description:
        "Boost your SaaS speed, uptime, and scalability with optimized cloud infrastructure.",
    },
    {
      icon: <Palette className="w-8 h-8" />,
      title: "UI/UX for SaaS",
      description:
        "Clean, modern, and intuitive dashboards & interfaces designed for SaaS end-users.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Build scalable, high-performance SaaS products with modern cloud
              technologies and secure multi-tenant architecture.
            </p>
          </div>
        </div>
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Essential modules to enhance your SaaS platform
            </p>
          </div>
      ...
      <motion.section
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-700">
            Let’s build a scalable, secure, and powerful SaaS platform tailored
